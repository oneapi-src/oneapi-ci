...
| Azure Pipelines| [.azure-pipelines.yml](https://github.com/oneapi-src/oneapi-ci/blob/master/.azure-pipelines.yml) | [![Build Status](https://dev.azure.com/robertscohn/oneapi-ci-mirror/_apis/build/status/robertscohn.oneapi-ci-mirror?branchName=master)](https://dev.azure.com/maximmzakharov/oneapi-ci/_build?definitionId=2)|+|+|+|+|+|+|+|+|+|+|+|
